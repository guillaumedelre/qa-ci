...
A [Docker](https://www.docker.com/)-based installer and runtime for the [Dunglas Symfony Docker](https://symfony.com) web framework, with full [HTTP/2](https://symfony.com/doc/current/weblink.html) and HTTPS support.
